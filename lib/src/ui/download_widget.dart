...
import 'package:sdk2009/src/ui/general_function.dart';
import 'package:sdk2009/src/utils/constants.dart';

class DownloadWidget extends StatefulWidget {
  const DownloadWidget({super.key, required this.title});
